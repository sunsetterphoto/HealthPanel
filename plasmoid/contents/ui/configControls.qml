...
Kirigami.FormLayout {
    ...
    QQC2.CheckBox { id: screenCheck; text: form.tr("Screen brightness") }
    QQC2.CheckBox { id: kbdCheck;    text: form.tr("Keyboard backlight") }
    QQC2.CheckBox { id: volumeCheck; text: form.tr("Volume + mute") }
}
